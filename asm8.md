...
|`ADDHX #wordval`   |Add immediate value to HX (useful for table offset adjustment)<br>Same as:<br><br>`PSHA` / `TXA` / `ADD #LSB` / `TAX` / `THA` / `ADC #MSB` / `TAH` / `PULA`
